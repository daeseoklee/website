...
A virtual ecosystem that (meant to) includes animals, plants, intelligence, and evolution.  
([pixelworld](https://github.com/daeseoklee/pixelworld ))
...
A simplified and modified version of *pixelworld*, written in python and cython.([miniworld](https://github.com/daeseoklee/miniworld ))
Here's a quantitative quasi-scientific argument that the intelligence part did work as intended.([here](https://github.com/daeseoklee/miniworld/blob/master/docs/draft.pdf ))

...
##### Todo
* I see [this](https://github.com/daeseoklee/miniworld/blob/master/docs/draft.pdf) article is not well-written, so I'm willing to edit it if anyone wants clarification.


#### hexago 
![hexago](images/hexago.resized.png)
Go played on a hexagonal board ([hexago](https://github.com/daeseoklee/hexago)).


##### Todo 
* Develop an easy interface to quickly generate a game of go on a custom board (an arbitrary simple planar graph).
